...
from catalog.emailer import send_admin_new_order_alert, send_order_confirmation_email
...
from catalog.routers.customer_auth import get_current_customer, get_optional_customer
